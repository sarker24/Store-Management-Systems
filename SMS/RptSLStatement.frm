...
Begin VB.Form RptSLStatement 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSLStatement.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSLStatement.frx":08DA
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSLStatement.frx":11B4
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "RptSLStatement"
...
Set rsMaster = New ADODB.Recordset
   ...
   rsMaster.Open "SELECT SerialNo, RDate, SName, SBill, TotalBill, Paid, Due, Posted, UName " & _
                 "From SStockMaster where  RDate='" & SSCurrentDate.Value & "' And Posted = 'Posted'and SStockMaster.SName='" & parseQuotes(cmbSupplierName) & "'", cn, adOpenStatic, adLockReadOnly
...
rsMaster.Open "SELECT SerialNo, RDate, SName, SBill, TotalBill, Paid, Due, Posted, UName " & _
              "From SStockMaster where  RDate BETWEEN '" & SSFDate.Value & "' AND '" & SSTDate.Value & "' And Posted = 'Posted' and SStockMaster.SName='" & parseQuotes(cmbSupplierName) & "'", cn, adOpenStatic, adLockReadOnly
...
Set rsMaster = New ADODB.Recordset
   ...
   rsMaster.Open "SELECT SerialNo, RDate, SName, SBill, TotalBill, Paid, Due, Posted, UName " & _
                 "From SStockMaster where  RDate='" & SSCurrentDate.Value & "' And Posted = 'Posted'", cn, adOpenStatic, adLockReadOnly
     ...
     rsMaster.Open "SELECT SerialNo, RDate, SName, SBill, TotalBill, Paid, Due, Posted, UName " & _
                   "From SStockMaster where  RDate BETWEEN '" & SSFDate.Value & "' AND '" & SSTDate.Value & "' And Posted = 'Posted'", cn, adOpenStatic, adLockReadOnly
