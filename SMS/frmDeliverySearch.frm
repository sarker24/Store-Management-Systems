...
Begin VB.Form frmDeliverySearch 
   BackColor       =   &H00C0B4A9&
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   750
      Left            =   7575
      Picture         =   "frmDeliverySearch.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   6
      Top             =   6240
      Width           =   1100
   ...
   Begin VB.CommandButton cmdOk 
      ...
      Height          =   750
      Left            =   6480
      Picture         =   "frmDeliverySearch.frx":08CA
      Style           =   1  'Graphical
      TabIndex        =   5
      Top             =   6240
      Width           =   1100
   ...
   Begin VB.CommandButton cmdFind 
      ...
      Height          =   750
      Left            =   5400
      Picture         =   "frmDeliverySearch.frx":1194
      Style           =   1  'Graphical
      TabIndex        =   4
      Top             =   6240
      Width           =   1100
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VSFlex7LCtl.VSFlexGrid fgExport 
         ...
         FormatString    =   $"frmDeliverySearch.frx":1A5E
         ScrollTrack     =   0   'False
         ScrollBars      =   3
         ScrollTips      =   0   'False
         MergeCells      =   0
   ...
   End
End
Attribute VB_Name = "frmDeliverySEarch"
