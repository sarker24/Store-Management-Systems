...
Begin VB.Form RPTStockPosition 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSBPMode.frx":058A
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSBPMode.frx":0E64
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSBPMode.frx":173E
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label Label1 
      BackColor       =   &H00000000&
      Caption         =   "Monthly Stock Report Information"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   18
         Charset         =   0
...
'       rsEmp.Open "exec Stock_Status2 '" & SSFDate & "', '" & SSTDate & "'", cn, adOpenStatic, adLockReadOnly
        rsEmp.Open "exec Monthly_Stock_Information '" & SSFDate.Value & "', '" & SSTDate.Value & "'", cn, adOpenStatic, adLockReadOnly
