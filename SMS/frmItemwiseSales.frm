...
Begin VB.Form RptReceivingItem 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Receiving Item Information"
   ClientHeight    =   4680
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6030
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label lblItemCatagory 
         ...
         Width           =   1935
      End
      Begin MSForms.ComboBox cmbPCatagory 
         Height          =   375
         Left            =   2040
         TabIndex        =   13
         Top             =   720
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmItemwiseSales.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmItemwiseSales.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmItemwiseSales.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label lblIWSSales 
      BackColor       =   &H00000000&
      Caption         =   "          Phurchase Item Information"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   14.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RptReceivingItem"
...
'rsTemp2.Open ("SELECT DISTINCT StoreName,Catagory FROM SubCatagory where StoreName='" & parseQuotes(cmbStoreName.text) & "'ORDER BY Catagory ASC"), cn, adOpenStatic
...
Set rsMaster = New ADODB.Recordset
 ...
 rsMaster.Open "SELECT SerialNo, RDate, SName, StoreName, Catagory, ItemName," & _
                 "Qty, Rate, Amount, Rol, ExpDate, Posted, Warranty, Remarks," & _
                 "CPost , Unit " & _
                 "FROM SStockDetails where  RDate='" & SSCurrentDate.Value & "'And CPost = 'Posted'and SStockDetails.StoreName='" & parseQuotes(cmbStoreName) & "'and SStockDetails.Catagory='" & parseQuotes(cmbPCatagory) & "'", cn, adOpenStatic, adLockReadOnly
  ...
  rsMaster.Open "SELECT SerialNo, RDate, SName, StoreName, Catagory, ItemName," & _
                 "Qty, Rate, Amount, Rol, ExpDate, Posted, Warranty, Remarks," & _
                 "CPost , Unit " & _
                 "FROM SStockDetails where RDate BETWEEN '" & SSFDate.Value & "' AND '" & SSTDate.Value & "'And CPost = 'Posted'and SStockDetails.StoreName='" & parseQuotes(cmbStoreName) & "'and SStockDetails.Catagory='" & parseQuotes(cmbPCatagory) & "'", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\ReceivingItem1.rpt"
...
Set rsMaster = New ADODB.Recordset
 ...
 rsMaster.Open "SELECT SerialNo, RDate, SName, StoreName, Catagory, ItemName," & _
                 "Qty, Rate, Amount, Rol, ExpDate, Posted, Warranty, Remarks," & _
                 "CPost , Unit " & _
                 "FROM SStockDetails where  RDate='" & SSCurrentDate.Value & "'And CPost = 'Posted'", cn, adOpenStatic, adLockReadOnly
  ...
  rsMaster.Open "SELECT SerialNo, RDate, SName, StoreName, Catagory, ItemName," & _
                 "Qty, Rate, Amount, Rol, ExpDate, Posted, Warranty, Remarks," & _
                 "CPost , Unit " & _
                "FROM SStockDetails where RDate BETWEEN '" & SSFDate.Value & "' AND '" & SSTDate.Value & "'And CPost = 'Posted'", cn, adOpenStatic, adLockReadOnly
...
On Error GoTo ErrH
    ...
    End If
        ...
        strPath = App.Path + "\reports\ReceivingItem.rpt"
        Set objReportApp = CreateObject("Crystal.CRPE.Application")
        Set objReport = objReportApp.OpenReport(strPath)
        Set objReportDatabase = objReport.Database
        Set objReportDatabaseTables = objReportDatabase.Tables
