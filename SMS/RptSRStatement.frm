...
Begin VB.Form RptSRStatement 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSRStatement.frx":000C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSRStatement.frx":08E6
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "RptSRStatement.frx":11C0
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.Label lblIWSSales 
      Alignment       =   2  'Center
      BackColor       =   &H00000000&
      Caption         =   "Store Phurchase Item Information"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   14.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RptSRStatement"
...
Set rsMaster = New ADODB.Recordset
 ...
 rsMaster.Open "SELECT SerialNo, RDate, SName, StoreName, Catagory, ItemName," & _
                 ...
                 "CPost , Unit " & _
                 "FROM SStockDetails where  RDate='" & SSCurrentDate.Value & "'And CPost = 'Posted'and SStockDetails.StoreName='" & parseQuotes(cmbStoreName) & "'", cn, adOpenStatic, adLockReadOnly
  ...
  rsMaster.Open "SELECT SerialNo, RDate, SName, StoreName, Catagory, ItemName," & _
                 "Qty, Rate, Amount, Rol, ExpDate, Posted, Warranty, Remarks," & _
                 "CPost , Unit " & _
                 "FROM SStockDetails where RDate BETWEEN '" & SSFDate.Value & "' AND '" & SSTDate.Value & "'And CPost = 'Posted'and SStockDetails.StoreName='" & parseQuotes(cmbStoreName) & "'", cn, adOpenStatic, adLockReadOnly
