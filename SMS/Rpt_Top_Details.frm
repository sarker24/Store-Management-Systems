...
Begin VB.Form Rpt_Top_Details 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Rpt_Top_Details.frx":0000
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Rpt_Top_Details.frx":08DA
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "Rpt_Top_Details.frx":11B4
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   End
End
Attribute VB_Name = "Rpt_Top_Details"
...
'       rsEmp.Open "exec Stock_Status2 '" & SSFDate & "', '" & SSTDate & "'", cn, adOpenStatic, adLockReadOnly
        rsEmp.Open "exec Stock_Statement_Details '" & SSFDate.Value & "', '" & SSTDate.Value & "'", cn, adOpenStatic, adLockReadOnly
...
'    On Error GoTo errh
    ...
    strPath = App.Path + "\reports\Top_Details.rpt"
