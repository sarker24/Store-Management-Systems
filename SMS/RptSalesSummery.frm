...
Begin VB.Form RptDeliveryItem 
   BackColor       =   &H00C0B4A9&
   Caption         =   "Delivery Report Statement"
   ClientHeight    =   4695
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   6000
   ...
   Begin VB.Label lblIWSSales 
      BackColor       =   &H00000000&
      Caption         =   "        Delivery Item Information"
      BeginProperty Font 
         Name            =   "Palatino Linotype"
         Size            =   14.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "RptDeliveryItem"
...
Set rsMaster = New ADODB.Recordset
   ...
   rsMaster.Open "SELECT SerialNo, ReqNo, DDate, DName, StoreName, Catagory, " & _
                 ...
                 "From SSalesDetails where  DDate='" & SSCurrentDate.Value & "' And CPost = 'Posted'and SSalesDetails.StoreName='" & parseQuotes(cmbStoreName) & "' and SSalesDetails.Catagory='" & parseQuotes(cmbPCatagory) & "'", cn, adOpenStatic, adLockReadOnly
...
rsMaster.Open "SELECT SerialNo, ReqNo, DDate, DName, StoreName, Catagory, " & _
                 "ItemName, Qty, Rate,Qty *  Rate as Amt, Remarks, CPost, Unit " & _
                 "From SSalesDetails where  DDate BETWEEN '" & SSFDate.Value & "' AND '" & SSTDate.Value & "' And CPost = 'Posted'and SSalesDetails.StoreName='" & parseQuotes(cmbStoreName) & "'and SSalesDetails.Catagory='" & parseQuotes(cmbPCatagory) & "'", cn, adOpenStatic, adLockReadOnly
